...
console.log(
  "Loaded CLIPDROP_API_KEY:",
  process.env.CLIPDROP_API_KEY ? "Exists ✅" : "Missing ❌"
);
...
export const resumeReview = async (req, res) => {
  try {
   ...
   const prompt=`Review the following resume and provide constructive feedback on its strengths,weakness and areas for improvement. Resume
   Content:\n\n ${pdfData.text}`
